    ...
    return (<>
        {showMessage && <div className="overlay">
            ...
            <div id="message" className="center" style={{ textAlign: "center", background: "white" }}>
                <p>Purpose of this website is creating a space that would have everything
                    that one needs to stay organized and updated every morning or anytime of the day,
                    Here you can plan your day as well as stay updated with
                    the world by looking at the daily updated news.
                    You get to decide what you have in mind. Go ahead and explore
