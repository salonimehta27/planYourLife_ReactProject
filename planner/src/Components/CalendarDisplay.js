...
function CalendarDisplay() {
    ...
    return (
        <div>
            ...
            <h5 onClick={() => setNote(!note)} style={{ color: "#8F25FA" }}>{note ? "Note: This Calendar is not Editable, this is just to view your Google Calendar at a glance & you can add or delete multiple calendars" : "Click to See note"}</h5>
            <br></br>
            {calendarDisplay}
        </div>
    )
